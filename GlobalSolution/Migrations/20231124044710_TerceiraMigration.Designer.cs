...
namespace GlobalSolution.Migrations
{
    ...
    [Migration("20231124044710_TerceiraMigration")]
            ...
            modelBuilder.Entity("GlobalSolution.Models.Pedido", b =>
                {
                    ...
                    b.Property<string>("TipoMedicacao")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GlobalSolution.Models.Prontuario", b =>
                {
                    b.HasOne("GlobalSolution.Models.Paciente", "Paciente")
                        .WithOne("prontuario")
                        .HasForeignKey("GlobalSolution.Models.Prontuario", "PacienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
